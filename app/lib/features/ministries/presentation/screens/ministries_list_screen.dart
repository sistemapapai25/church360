...
class MinistriesListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      floatingActionButton: ministriesAsync.maybeWhen(
            ...
            children: [
              ...
              membersAsync.when(
                data: (members) {
                  ...
                  final coordinators = members.where((m) => m.role == MinistryRole.coordinator).length;
                  final regularMembers = members.where((m) => m.role == MinistryRole.member).length;
