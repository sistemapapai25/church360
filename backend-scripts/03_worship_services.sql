...
-- Tabela: worship_service
-- Cultos/serviços religiosos
CREATE TABLE worship_service (
...
CREATE INDEX idx_worship_service_date ON worship_service(service_date DESC);
CREATE INDEX idx_worship_service_type ON worship_service(service_type);
CREATE INDEX idx_worship_attendance_service ON worship_attendance(worship_service_id);
CREATE INDEX idx_worship_attendance_member ON worship_attendance(member_id);
