...
class MemberProfileScreen extends ConsumerWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSection(
            ...
            child: _buildPersonalInfo(context, member),
          ),
  ...
  Widget _buildPersonalInfo(BuildContext context, Member member) {
    return Column(
      children: [
        ...
        _buildInfoRow(Icons.work, 'Profissão', member.profession ?? 'Não informado'),
        _buildInfoRow(
          Icons.favorite,
          'Estado Civil',
