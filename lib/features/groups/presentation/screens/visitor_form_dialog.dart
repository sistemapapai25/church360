...
class VisitorFormDialog extends ConsumerStatefulWidget {
  ...
  const VisitorFormDialog({super.key, required this.meetingId});
  ...
  Future<void> _saveVisitor() async {
    ...
    try {
      ...
      final data = {
        ...
        'gender': _gender,
        'how_found_us': _howFoundUsController.text.trim().isEmpty
            ? null
            : _howFoundUsController.text.trim(),
                    ...
                    child: Column(
                      children: [
                        ...
                        DropdownMenu<_GenderOption>(
                          ...
                          leadingIcon: const Icon(AppIcons.gender),
                          dropdownMenuEntries: genderOptions
                              .map(
                                (option) => DropdownMenuEntry<_GenderOption>(
                                  value: option,
                                  label: option.label,
                                ),
                              )
