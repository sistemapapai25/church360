...
class _EventRegistrationScreenState
  ...
  Widget _buildUnavailableScreen(BuildContext context) {
    ...
    if (semSessao) {
      ...
      final destino = Uri.encodeComponent('/events/${widget.eventId}/register');
      return _buildAccessStateScreen(
        context,
        icon: AppIcons.login,
                ...
                if (existing != null) {
                  return _buildTicketScreen(
                    ...
                    EventTicket(
                      ...
                      qrCode:
                          existing.qrCode ??
                          'EVENT_TICKET:${event.id}:${member.id}',
                      status: 'paid',
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(AppIcons.personFilled),
                ),
              ),
              ...
              FilledButton.icon(
                ...
                label: Text(
                  _isGuestRegistering ? 'Enviando...' : 'Concluir inscrição',
                ),
              ),
  ...
  Future<void> _registerGuestInEvent(Event event) async {
    ...
    if (name.isEmpty || email.isEmpty || !email.contains('@')) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Informe um nome e e-mail válidos para concluir a inscrição.',
          ),
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Image.network(
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      return Container(
                        ...
                        child: const Icon(AppIcons.eventFilled, size: 64),
                      );
                    },
                  ),
                ),
              ...
              if (event.location != null)
                _buildInfoRow(AppIcons.location, 'Local', event.location!),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Icon(
                      isFree ? AppIcons.gift : AppIcons.money,
                      size: 48,
              ...
              if (!isFree) ...[
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(AppIcons.info, color: Colors.orange[700]),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Text(
  ...
  Future<void> _registerInEvent(Event event, dynamic member) async {
    if (member == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Você precisa ter um perfil de membro para se inscrever',
          ),
        ),
      );
      return;
    ...
    try {
      ...
      setState(() {
        _generatedTicket = EventTicket(
          ...
          memberId: member.id,
          qrCode:
              registration.qrCode ?? 'EVENT_TICKET:${event.id}:${member.id}',
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(AppIcons.info, color: Colors.blue[700]),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Text(
