  ...
  IF EXISTS (
    ...
    EXECUTE $sql$
      ...
      DECLARE
        ...
        safe_full_name text;
        safe_nickname text;
        ual_level public.access_level_type;
        ual_level_number integer;
      BEGIN
        uid := auth.uid();
        IF uid IS NULL THEN
        ...
        SELECT ual.access_level, ual.access_level_number
        INTO ual_level, ual_level_number
        ...
        IF FOUND THEN
          ...
          VALUES (tid, uid, ual_level, ual_level_number, true)
